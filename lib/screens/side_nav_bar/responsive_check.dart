...
class ResponsiveCheck extends StatefulWidget {
  @override
  _ResponsiveCheckState createState() =>
      _ResponsiveCheckState();
}
      ...
      body: Row(
        children: [
          ...
          AnimatedContainer(
            ...
            width: isCollapsed ? width * .04 : width * .15,
            color: Colors.white,
            child: Column(
              children: [
                // Profile Section
                Padding(
                  ...
                  child: isCollapsed
                    ...
                    child: Center(child: Image.network('https://static.vecteezy.com/system/resources/thumbnails/019/900/322/small/happy-young-cute-illustration-face-profile-png.png', height: height * .04,),),
                  )
                      : Row(
